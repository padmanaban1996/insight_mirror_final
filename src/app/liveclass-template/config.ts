///mukunthan ->for custom config change parameters here to our backend
...
export const jitsiConfig = {
    ...
    //we can integrate google analytics and from that api we can get data to our dashboad
    analytics: {
    ...
    //this avoids the extra pre-join page on mobile.
